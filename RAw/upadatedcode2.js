        ...
        for (var param in e.parameter) {
            ...
            switch (param) {
                case 'M':
                    ...
                    var Colrange = sheet.getRange(7, YRCELLNO).getA1Notation();
                    var ColNum = Colrange[0];
                    ...
                    var Syrrange = sheet.getRange(5, YRCELLNO + 1);
                    var Sbyear = Syrrange.getValue();
                    // End batch year of student--------------------
                    var Eyrrange = sheet.getRange(5, YRCELLNO + 3);
                    ...
                    if (Entrystatus == 'OnTime') {
                        ...
                        var Emailrange = sheet.getRange(6, YRCELLNO);
                    ...
                    function fyrattendance() {
                        if (Curr_Day == 0 || Curr_Day == 6) {
                            ...
                            if (BREAKFAST) {
                                ...
                                if (B_HTime_1_2yr) {
                                    rowData[ROWO + 3] = Entrystatus = 'OnTime';
                                } else {
                                    rowData[ROWO + 3] = Entrystatus = 'Late';
                                }
                            } else if (LUNCH) {
                                rowData[ROWO] = new Date();
                                rowData[ROWO + 1] = Curr_Time;
                            ...
                            if (BREAKFAST) {
                                ...
                                rowData[ROWO] = new Date();
                                rowData[ROWO + 1] = Curr_Time;
                                rowData[ROWO + 3] = Entrystatus = '#Invalid';
                            }
                        ...
                        if (Curr_Day == 0 || Curr_Day == 6) {
                            ...
                            if (BREAKFAST) {
                                ...
                                if (B_HTime_othersyr) {
                                    ...
                                    rowData[ROWO + 3] = Entrystatus = 'Before Time';
                                } else {
                                    rowData[ROWO + 3] = Entrystatus = 'Late';
                                }
                            } else if (LUNCH) {
                    ...
                    result = 'MessCode printed successfully ' + SemYr + ' ' + Entrystatus + ' ' + EmailQuotaRemaining + ' ' + ColNum;
                    break;
                default:
                    result = "unsupported parameter";
            }
        }
        var Colrange = ColNum + 1 + ':' + ColNum;

        const lrow = sheet.getLastRow();
        const Avals = sheet.getRange(Colrange + lrow).getValues();
